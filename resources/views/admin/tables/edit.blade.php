            ...
            <div>
                ...
                <form method="post" action="{{ route('admin.tables.update',$tables->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="name" name="name" value="{{ $tables->name ? $tables->name : ''  }}"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="guestnumber" name="guest_number" value="{{ $tables->guest_number ? $tables->guest_number : ''  }}"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            placeholder="" required>
                    </div>
                    <div class="mb-6">
