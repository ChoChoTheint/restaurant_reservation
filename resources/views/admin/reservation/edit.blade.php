<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div>
                <form method="post" action="{{ route('admin.reservation.update', $reservations->id) }}"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="first_name" name="first_name"
                            value="{{ $reservations->first_name ? $reservations->first_name : '' }}"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="last_name" name="last_name"
                            value="{{ $reservations->last_name ? $reservations->last_name : '' }}"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            placeholder="">
                        @error('last_name')
                            <div class="alert alert-danger text-red-400">{{ $message }}</div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" id="email" name="email"
                            value="{{ $reservations->email ? $reservations->email : '' }}"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            placeholder="">
                        @error('email')
                            <div class="alert alert-danger text-red-400">{{ $message }}</div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="tel_number" name="tel_number"
                            value="{{ $reservations->tel_number ? $reservations->tel_number : '' }}"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            placeholder="">
                        @error('tel_number')
                            <div class="alert alert-danger text-red-400">{{ $message }}</div>
                    ...
                    <div class="mb-6">
                        <label for="res_date"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reverstaion
                            Date</label>
                        <input type="date" id="res_date" name="res_date"
                            value="{{ $reservations->res_date ? $reservations->res_date : '' }}"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            placeholder="">
                        @error('res_date')
                            <div class="alert alert-danger text-red-400">{{ $message }}</div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="guest_number" name="guest_number"
                            value="{{ $reservations->guest_number ? $reservations->guest_number : '' }}"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            placeholder="">
                        @error('guest_number')
                            <div class="alert alert-danger text-red-400">{{ $message }}</div>
